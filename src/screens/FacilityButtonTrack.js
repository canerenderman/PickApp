...
export default class FacilityButtonTrack extends Component {
    ...
    postRequest() {
        var url = "https://pickapp-test.herokuapp.com/api/users/2/track";
        var options = {
            'method': 'POST',
            'headers': {
            ...
            <View>
                <View style={styles.container}>
                    <TouchableOpacity style={styles.sub_gym} onPress={() => this.postRequest()}>
                        <Image style={styles.image} source={require('./Icons/tracks.png')}/>
                    </TouchableOpacity>
                    {this._renderSubGym()}
                </View>
            </View>
